...
**This file is self-contained.** The six scripts it refers to are printed in
...
`cantai_mode.py`, `lyric_collisions.py`, `stem_vs_score.py`. There are no other
files to obtain.
...
All six are complete and standalone. Write them out as-is; nothing else is
